...
# Try and determine the desktop environment
desktop_env = desktop_functions.get_desktop_environment()
if desktop_env == 'unknown':
	print('Unable to detect your desktop environment.')
	sys.exit()
	...
	# If the desktop environment appears to be GTK based
	if os.path.exists(xml_file):
		...
		print('MacOS Catalina style wallpaper has been moved to: {0}'.format(catalina_wallpaper_path))
